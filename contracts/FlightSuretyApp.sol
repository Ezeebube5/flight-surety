...
contract FlightSuretyApp {
    ...
    function getFlightStatus(string flight, uint256 _timestamp, address airline)
        external
        requireIsOperational()
        returns (
            bool exist,
    ...
    function registerFlight(string _flight, uint256 _timestamp, uint256 _price)
        external
        requireIsOperational()
        requireRegisteredUser(msg.sender)
    {
    ...
    /**                                                   */
    /******************************************************/
    function getTicketPrice(string flight, uint256 _timestamp, address airline)
        external
        requireIsOperational()
    ...
    function isInsured(string flight, uint256 _timestamp, address airline)
        external
        requireIsOperational()
        returns (bool)
    {
    ...
    function getCredit(string flight, uint256 _timestamp, address airline)
        external
        requireIsOperational()
    {
        bytes32 key = getFlightKey(airline, flight, _timestamp);
...
contract FlightSuretyData {
    ...
    function addRegisteredFlight(bytes32 key, uint256 price, uint256 time)
        external;

    function buy(bytes32 key, address buyer, bool withInsurance)
        external
        payable;
